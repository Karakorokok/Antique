    ...
    <div class="my-4">
        <div>
            ...
            <div class="bg-custom-yellow mx-3 p-2 rounded">
                <div class="h5">
                    Points: <span><?= ($UserDetails['real_timepoints'] == null) ? 0 : $UserDetails['real_timepoints']; ?></span>
                </div>
            </div>
            ...
            <?php foreach($Rewards as $Reward): ?>
                <div class="col-md-3 col-6 list-item mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h6 class="card-title"><?=$Reward['rewards_name'];?></h6>
                            <h6 class="card-title"><?=$Reward['points_required'];?></h6>
                            <button type="button" class="btn btn-outline-danger w-100 mb-2" data-bs-toggle="modal" data-bs-target="#viewDetailsModal" 
                            ...
                            >View Details</button>
                            <button type="button" class="btn btn-info w-100" data-bs-toggle="modal" data-bs-target="#redeemModal" data-rewards_id="<?=$Reward['rewards_id'];?>"
